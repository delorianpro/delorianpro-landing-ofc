    ...
    <div className={styles.heroColumnRight}>
      <div>
        ...
        <div className={styles.heroColumnRightBlocks}>
          <div className={styles.heroColumnRightListItens}> <Link href={"#servicosDelorianId"} className={styles.heroColumnRightListLink}><Image src="/assets/cadeBlueIcon.webp" alt={"Ícone de um cadeado na cor branca"} width={100} height={100} priority={true} className={styles.iconsLinks}/>Controle de <br /> acesso</Link></div>
      ...
      <div>
       ...
       <div>
        ...
        <div className={`${styles.heroColumnRightBlocks} ${styles.heroColumnRightBlocksLast}`}>
          <div className={styles.heroColumnRightListItens}> <Link href={"#servicosDelorianId"} className={styles.heroColumnRightListLink}><Image src="/assets/modWifiIcon.webp" alt={"Ícone de rede de sinal na cor branca"} width={100} height={100} priority={true} className={styles.iconsLinksGrid3}/>Módulo <br /> wi-fi</Link></div>
          <div className={styles.heroColumnRightListItens}> <Link href={"#servicosDelorianId"} className={styles.heroColumnRightListLink}><Image src="/assets/escudBlueIcon.webp" alt={"Ícone de um escudo na cor branca"} width={100} height={100} priority={true} className={styles.iconsLinksGrid3}/>Sensores</Link></div>
          <div className={styles.heroColumnRightListItens}> <Link href={"#servicosDelorianId"} className={styles.heroColumnRightListLink}><Image src="/assets/carrBlueIcon.webp" alt={"Ícone de um carro na cor branca"} width={100} height={100} priority={true} className={styles.iconsLinksGrid3}/>Tx-Car</Link></div>
        </div>
      </div>    
    </div>
    </div>
